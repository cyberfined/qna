# -*- encoding: utf-8 -*-
# stub: webpacker 6.0.0.pre.2 ruby lib

Gem::Specification.new do |s|
  s.name = "webpacker".freeze
  s.version = "6.0.0.pre.2"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "changelog_uri" => "https://github.com/rails/webpacker/blob/v6.0.0.pre.2/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/webpacker/tree/v6.0.0.pre.2" } if s.respond_to? :metadata=
